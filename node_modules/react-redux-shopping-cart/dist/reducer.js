...
exports.createCart = exports.setCart = undefined;
...
var _setCart = function _setCart(payload) {
  return {
...
var createCart = exports.createCart = function createCart(_ref) {
  var dispatch = _ref.dispatch;
  return {
    setCart: function setCart(state) {
      dispatch(_setCart(state));
    }
  };
};

var ACTION_HANDLERS = (_ACTION_HANDLERS = {}, _ACTION_HANDLERS[actions.SET_CART] = function (state, action) {
  return update(_extends({}, state, action.payload));
}, _ACTION_HANDLERS[actions.ADD_TO_CART] = function (state, action) {
